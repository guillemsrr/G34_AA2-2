...
/*
const std::string CENTRAL_EXPLOSION = "CENTRAL_EXPLOSION";
const std::string VERTICAL_EXPLOSION = "VERTICAL_EXPLOSION";
const std::string LEFT_EXPLOSION = "LEFT_EXPLOSION";
const std::string RIGHT_EXPLOSION = "RIGHT_EXPLOSION";
const std::string SMALL_VERTICAL_EXPLOSION = "SMALL_VERTICAL_EXPLOSION";
*/
